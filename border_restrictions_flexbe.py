...
class BorderRestrictions(EventState):
    ...
    -- position_x           float           The distance of x between the center of plane0 and the frame_id
    -- position_y           float           The distance of y between the center of plane0 and the frame_id
    -- position_z           float           The distance of z between the center of plane0 and the frame_id
