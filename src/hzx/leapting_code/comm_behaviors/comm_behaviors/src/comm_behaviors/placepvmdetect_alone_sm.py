...
@author: zcx
'''
class PlacePVMDetect_aloneSM(Behavior):
	'''
	...
	def __init__(self):
		super(PlacePVMDetect_aloneSM, self).__init__()
		self.name = 'PlacePVMDetect_alone'
	...
	def create(self):
		...
		_state_machine.userdata.goal_z_rpz = {'pos':[0,0,-0.05], 'quat':[0,0,0,1], 'target_frame':'tool0'}
