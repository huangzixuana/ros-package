	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('arm_operate',
										ArmSiteCdsrSrdfYaml(srdf_path='~/catkin_ws/src/leapting/kr210r2700_moveit_config/config/kr210r2700.srdf', yaml_path='~/catkin_ws/dbparam/arm_waypoints.yaml', source_frame='base_arm', target_frame='tool0', operation=self.operation, operation_file=self.operation_file, site_name=self.site_name),
