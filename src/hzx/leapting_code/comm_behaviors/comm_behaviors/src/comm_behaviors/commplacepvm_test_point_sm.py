...
from comm_behaviors.placepvmdetect_test_point_sm import PlacePVMDetect_test_pointSM
...
@author: why
'''
class CommPlacePVM_test_pointSM(Behavior):
	'''
	PlacePVM
	'''
	...
	def __init__(self):
		super(CommPlacePVM_test_pointSM, self).__init__()
		self.name = 'CommPlacePVM_test_point'

		# parameters of this behavior
		self.add_parameter('mode', 'SimPlacePVM')
		self.add_parameter('pvm_width', 1134)
		self.add_parameter('install_gap', -20)
		...
		self.add_behavior(PlacePVMDetect_test_pointSM, 'PlacePVMDetect_test_point')
	...
	def create(self):
		...
		with _state_machine:
			...
			# x:758 y:665
			OperatableStateMachine.add('PlacePVMDetect_test_point',
										self.use_behavior(PlacePVMDetect_test_pointSM, 'PlacePVMDetect_test_point',
											parameters={'place_solar_x': self.place_solar_x, 'pvm_width': self.pvm_width, 'install_gap': self.install_gap, 'place_solar_z': self.place_solar_z, 'en_bracket': False, 'en_plane': False, 'yline_gap': 67, 'line_z': self.line_z}),
			...
			OperatableStateMachine.add('detectDec',
										...
										transitions={'line': 'PlacePVMDetect_test_point', 'bkt': 'armPlacePVM', 'pvm': 'armPlacePVM', 'invalid': 'detectDec'},
